...
public import Problib.QuasiBorel.Measurable.Family
public import Problib.Measure.Kernel.Comap
public import Problib.Measure.Kernel.Precomp
public import Problib.Measure.Kernel.Piecewise.Countable
...
@[expose] noncomputable def toKernel_precomp_sfinite {domain codomain : Space realSource}
  ...
  let family := Classical.choice (morphism.map_random accepted)
