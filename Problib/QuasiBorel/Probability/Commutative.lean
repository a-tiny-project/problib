import Problib.Measure.Giry.Commutative
...
private theorem bindContext_source (first : Law left) (second : Law right)
...
theorem bind_comm (first : Law left) (second : Law right)
  ...
  have joint : MeasurableMap (Problib.Measure.Space.product borel borel)
