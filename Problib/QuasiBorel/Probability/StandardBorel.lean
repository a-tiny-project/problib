...
variable {α : Type u} {β : Type v} {source : Problib.Measure.Space α}
  {target : Problib.Measure.Space β}

private theorem forward_measurable (presentation : Problib.Measure.StandardBorel source) :
    MeasurableMap (Space.ofMeasurable borel source).toMeasurable source (fun point => point) := by
  rw [Space.toMeasurable_of_standardBorel_real presentation]
  exact MeasurableMap.identity source

private theorem inverse_measurable (presentation : Problib.Measure.StandardBorel source) :
    MeasurableMap source (Space.ofMeasurable borel source).toMeasurable (fun point => point) := by
  rw [Space.toMeasurable_of_standardBorel_real presentation]
  exact MeasurableMap.identity source

private def correspondence (presentation : Problib.Measure.StandardBorel source) :
...
private theorem retract_map (presentation : Problib.Measure.StandardBorel source)
...
noncomputable def ofGiry (presentation : Problib.Measure.StandardBorel source)
...
theorem ofGiry_val (presentation : Problib.Measure.StandardBorel source)
    (law : Giry.Law source) :
...
noncomputable def toGiry (presentation : Problib.Measure.StandardBorel source)
...
theorem toGiry_ofGiry (presentation : Problib.Measure.StandardBorel source)
...
theorem ofGiry_toGiry (presentation : Problib.Measure.StandardBorel source)
...
noncomputable def ofGiryHom (presentation : Problib.Measure.StandardBorel source) :
  ...
  map_random := by
    ...
    let fallback := Classical.choice (random Problib.Real.Construction.Dedekind.zero).property.nonempty
    refine ⟨{
...
noncomputable def toGiryHom (presentation : Problib.Measure.StandardBorel source) :
...
theorem toGiryHom_ofGiryHom (presentation : Problib.Measure.StandardBorel source) :
...
theorem ofGiryHom_toGiryHom (presentation : Problib.Measure.StandardBorel source) :
...
theorem ofGiry_pure (presentation : Problib.Measure.StandardBorel source) (point : α) :
...
theorem ofGiry_map (first : Problib.Measure.StandardBorel source)
    (second : Problib.Measure.StandardBorel target) (function : α → β)
...
theorem ofGiry_bind (first : Problib.Measure.StandardBorel source)
    (second : Problib.Measure.StandardBorel target) (law : Giry.Law source)
...
theorem kernel_measurable (first : Problib.Measure.StandardBorel source)
    (second : Problib.Measure.StandardBorel target)
  ...
  Hom.measurable_of_standardBorel_real first (Hom.comp (toGiryHom second) kernel)

/-- toGiry commutes with monadic bind, recovering the Giry bind of exported kernels. -/
theorem toGiry_bind (first : Problib.Measure.StandardBorel source)
    (second : Problib.Measure.StandardBorel target) (law : Law (Space.ofMeasurable borel source))
    (kernel : Hom (Space.ofMeasurable borel source) (object (Space.ofMeasurable borel target))) :
