...
public import Problib.QuasiBorel.Sum.Laws
...
-/
namespace Problib.QuasiBorel.Sum.Necessity
...
public theorem unrestricted_empty_is_not_initial :
  ...
  rintro ⟨morphism⟩
  exact morphism.map_random (random := fun seed => seed) True.intro

end Problib.QuasiBorel.Sum.Necessity
