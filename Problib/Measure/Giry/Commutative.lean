import Problib.Measure.Giry.Strength
...
theorem integral_swap (left : Law source) (right : Law target)
  ...
  (lintegral_prod left.val right.val (Measure.SFinite.ofFinite right.property.to_finite)
    measurable).symm.trans
    (lintegral_prod_symm left.val right.val (Measure.SFinite.ofFinite left.property.to_finite)
      (Measure.SFinite.ofFinite right.property.to_finite) measurable)
...
theorem product_measure (left : Law source) (right : Law target) :
    (product left right).val =
      Measure.prod left.val right.val (Measure.SFinite.ofFinite right.property.to_finite) := rfl
...
theorem product_apply (left : Law source) (right : Law target)
  ...
  Measure.prod_apply_product left.val right.val
    (Measure.SFinite.ofFinite right.property.to_finite) leftMeasurable rightMeasurable
...
theorem product_swap (left : Law source) (right : Law target) :
  ...
  Subtype.ext (Measure.prod_swap_ofFinite left.property.to_finite right.property.to_finite)
