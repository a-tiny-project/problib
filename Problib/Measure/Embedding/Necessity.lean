...
namespace Problib.Measure.Embedding.Necessity

/-- A measurable map admitting a measurable left inverse can have a nonmeasurable range. -/
public theorem measurable_left_inverse_does_not_force_measurable_range :
...
end Problib.Measure.Embedding.Necessity
