...
public structure SimpleFunction {alpha : Type u} (source : Space alpha) where
  ...
  preimage_singleton_measurable : ∀ value, source.Measurable
    (Set.preimage toFunction (ennrealSingleton value))
  finite_range : HasFiniteRange toFunction
...
public noncomputable def ofCandidates
  ...
  toFunction := function
  preimage_singleton_measurable := fibersMeasurable
  finite_range := ⟨exactValues function candidates,
...
public theorem fiber_measurable (function : SimpleFunction source)
  ...
  exact function.preimage_singleton_measurable value
...
public theorem pointwiseLe_refl (function : SimpleFunction source) :
  ...
  fun input => ENNReal.le_refl (function input)
...
public theorem pointwiseLe_trans {first second : SimpleFunction source}
  ...
  fun input => ENNReal.le_trans (firstSecond input) (secondThird input)
