...
public import Problib.Measure.Kernel.Rejection.Restriction
public import Problib.Measure.Uniform

set_option autoImplicit false

namespace Problib.Measure.Kernel.Rejection
open Problib.Real
...
public theorem uniform_initial_retry (upper : Real.UnitInterval)
    ...
    loop (retry (fun _ : Unit => Real.uniform01 (Set.complement (Real.unitInitial upper)))
      ...
      Measure.normalize (Real.uniform01.restrict (Real.unitInitial upper))
        ⟨Real.uniform01_isProbability.to_finite.restrict _, by
  ...
  apply loop_restriction_retry_eq_normalize Real.uniform01 Real.uniform01_isProbability
    (Real.unitInitial upper) (Real.unitInitial_measurable upper)
...
end Problib.Measure.Kernel.Rejection
