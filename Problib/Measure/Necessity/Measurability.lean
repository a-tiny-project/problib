...
public import Problib.Measure.Integral.Simple.Integral.Transport
public import Problib.Measure.Additive.Finite

set_option autoImplicit false

namespace Problib.Measure.Necessity.Measurability
...
public theorem function_not_ae_zero :
  ...
  have member : superset true := included ENNReal.one_ne_zero
  ...
  exact ENNReal.one_ne_zero nullSet
...
end Problib.Measure.Necessity.Measurability
