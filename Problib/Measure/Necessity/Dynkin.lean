...
theorem checkerboard_measures_agree_on_generators
  ...
  · subst set
    ...
    rw [Measure.add_apply_measurable _ _ checkerboardFirst_measurable,
      ...
      Measure.dirac_apply _ _ checkerboardFirst_measurable,
      Measure.dirac_apply _ _ checkerboardFirst_measurable]
    simp [checkerboardFirst, ENNReal.zero_add]
  · subst set
    unfold checkerboardDiagonal checkerboardOffDiagonal
    rw [Measure.add_apply_measurable _ _ checkerboardSecond_measurable,
      ...
      Measure.dirac_apply _ _ checkerboardSecond_measurable,
      Measure.dirac_apply _ _ checkerboardSecond_measurable]
    simp [checkerboardSecond, ENNReal.zero_add, ENNReal.add_zero]
...
theorem checkerboard_measures_ne :
  ...
  exact ENNReal.one_ne_zero cornerEqual

theorem piSystem_is_necessary_for_finite_measure_uniqueness :
  ...
  ⟨rfl, checkerboardGenerators_contains_univ,
    ...
    checkerboard_measures_agree_on_generators, checkerboard_measures_ne,
