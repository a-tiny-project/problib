...
public import Problib.Measure.Kernel.Distribution.Bounds
...
public theorem initialMarginal_mono
  ...
  exact joint.mono (fun _ member => ⟨Dedekind.le_trans member.1 included, member.2⟩)
...
public theorem le_conditional_initial
  ...
  exact ENNReal.ofReal_monotone (DistributionFunction.le_ofUpperBounds unitRationalBasis
