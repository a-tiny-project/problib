...
public import Problib.Measure.Integral.Density.Unit
...
public theorem unitDensity_measurable (finite : SigmaFinite reference)
  ...
  MeasurableMap.comp Real.unitClamp_measurable
    (dominatedDerivative finite included).density_measurable.measurableMap
...
public theorem exists_unit_density_iff (finite : SigmaFinite reference) :
