...
public import Problib.Measure.Decomposition.ZeroInfinity.Uniqueness.Basic
...
public theorem withDensity_eq_iff_aeInfinityEq {measure : Measure space}
  ...
  · intro equal
    constructor
    · apply Measure.aeEq_of_withDensity_eq (top.sigmaFinite_complement finite)
        leftMeasurable rightMeasurable
      rw [measure.withDensity_restrict left (space.complement top.zero_infinity.measurable),
        measure.withDensity_restrict right (space.complement top.zero_infinity.measurable), equal]
  ...
  · intro agree
    have inside : (measure.restrict top.set).withDensity left =
      ...
      rw [IsZeroInfinitySet.withDensity_restrict_eq_restrict_support top.zero_infinity leftMeasurable,
        IsZeroInfinitySet.withDensity_restrict_eq_restrict_support top.zero_infinity rightMeasurable]
    ...
    rw [measure.withDensity_restrict left top.zero_infinity.measurable,
      measure.withDensity_restrict right top.zero_infinity.measurable] at inside
    rw [measure.withDensity_restrict left (space.complement top.zero_infinity.measurable),
      measure.withDensity_restrict right (space.complement top.zero_infinity.measurable)] at outside
    apply Measure.ext
    ...
    rw [← (measure.withDensity left).inter_add_difference set top.zero_infinity.measurable,
      ← (measure.withDensity right).inter_add_difference set top.zero_infinity.measurable,
      insideMass]
