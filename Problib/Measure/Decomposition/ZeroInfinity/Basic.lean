...
public structure TopZeroInfinitySet (measure : Measure space) : Type u where
  set : Set alpha
  zero_infinity : IsZeroInfinitySet measure set
...
public theorem TopZeroInfinitySet.equal_modulo_null
  ...
  ⟨right.greatest left.zero_infinity,
    left.greatest right.zero_infinity⟩
