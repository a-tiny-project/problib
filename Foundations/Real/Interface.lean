...
public import Foundations.Algebra.Order
...
public structure CompleteLinearOrder (α : Type) where
  order : Foundations.Algebra.LinearOrderLaws α
...
public structure AdditiveOrderExtension (base : OrderedSelection) where
  group : Foundations.Algebra.AdditiveCommutativeGroupLaws base.Carrier
  translation : Foundations.Algebra.TranslationMonotone base.Carrier
...
@[expose] public def orderedGroup {base : OrderedSelection}
    ...
    Foundations.Algebra.OrderedAdditiveCommutativeGroupLaws
      base.Carrier where
...
@[expose] public def linearlyOrderedGroup {base : OrderedSelection}
    (extension : AdditiveOrderExtension base) :
    Foundations.Algebra.LinearlyOrderedAdditiveCommutativeGroupLaws
      base.Carrier where
  order := base.completeOrder.order.toPreorderLaws
  group := extension.group
  translation := extension.translation
