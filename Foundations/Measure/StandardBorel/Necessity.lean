...
public import Foundations.Measure.StandardBorel.Pi

set_option autoImplicit false

namespace Foundations.Measure.StandardBorel.Necessity
...
theorem emptyIndexProduct_standardBorel :
...
theorem countableEmptyProduct_standardBorel :
...
theorem countableEmptyProduct_empty : ¬Nonempty (Nat → Empty) :=
  fun ⟨point⟩ => nomatch point 0

end

end Foundations.Measure.StandardBorel.Necessity
