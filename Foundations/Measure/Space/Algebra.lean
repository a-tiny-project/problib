...
import Foundations.Countable.Bijection
...
decreasing_by
  ...
  · exact Nat.lt_succ_of_le
      (Nat.le_trans (Countable.Pair.decodeFirstLe _) (Nat.div_le_self _ _))
  · exact Nat.lt_succ_of_le
      (Nat.le_trans (Countable.Pair.decodeSecondLe _) (Nat.div_le_self _ _))
            ...
            · rw [if_neg complement]
              exact space.union
                (induction _ (Nat.lt_succ_of_le (Nat.le_trans
                  (Countable.Pair.decodeFirstLe _) (Nat.div_le_self _ _))))
                (induction _ (Nat.lt_succ_of_le (Nat.le_trans
                  (Countable.Pair.decodeSecondLe _) (Nat.div_le_self _ _))))
