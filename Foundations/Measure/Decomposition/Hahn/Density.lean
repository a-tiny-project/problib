...
namespace Foundations.Measure.Measure.HahnDecomposition
...
public theorem ae_density_le_on_region (decomposition : HahnDecomposition left right)
  ...
  apply ae_le_of_withDensity_le_finite (finite.restrict decomposition.region)
    rightDerivative.densityMeasurable leftDerivative.densityMeasurable
...
end Foundations.Measure.Measure.HahnDecomposition
