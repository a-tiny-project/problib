...
public import Foundations.Measure.AlmostEverywhere
public import Foundations.Measure.Integral.Lebesgue.Algebra
public import Foundations.Measure.Integral.Simple.Integral.Operations
...
public theorem lintegral_mono_ae {left right : alpha → ENNReal}
  ...
  · rw [lower.restrict_apply_of_mem region regionMeasurable value outside]
    exact ENNReal.leTrans (lowerBound value) (outsideBound value outside)
