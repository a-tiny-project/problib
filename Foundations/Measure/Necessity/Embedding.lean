...
namespace Foundations.Measure.Necessity.Embedding
...
public theorem collapse_image_formula_impossible :
  ...
  exact ENNReal.oneNeZero
    (ENNReal.addLeftCancelOfFinite (factor := ENNReal.one) True.intro equal)
...
end Foundations.Measure.Necessity.Embedding
