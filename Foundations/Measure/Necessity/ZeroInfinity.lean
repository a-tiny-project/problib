...
public theorem sFinite_zeroInfinity_need_not_be_null :
...
public theorem reference_top_mass (top : Measure.TopZeroInfinitySet Density.reference) :
  ...
  exact (top.zeroInfinity.subsets_zero_or_top top.zeroInfinity.measurable
...
public theorem reference_top_complement_eq_zero
  ...
  have null := top.greatest reference_univ_zeroInfinity
...
public theorem dirac_not_zeroInfinityAbsolutelyContinuous :
  ...
  intro continuous
  have zeroInfinity := continuous.preservesZeroInfinity Necessity.ZeroInfinity.reference_univ_zeroInfinity
  ...
  · exact ENNReal.oneNeZero zero
  · exact ENNReal.finiteNeTop NNReal.one infinite
...
end Foundations.Measure.Necessity.ZeroInfinity
