...
public import Foundations.Measure.Kernel.Hahn.Basic
public import Foundations.Measure.Decomposition.Hahn.Countable
...
public theorem exists_approximation (algebra : Space.CountableAlgebra target)
  ...
  exact ⟨fun input => algebra.sets (selection input),
    Space.selectedSet_measurable selectionMeasurable algebra.sets algebra.toCountableGenerator.measurable,
    selected⟩
...
public theorem exists_hahnDecomposition_ofCountableGenerator
...
public noncomputable def HahnDecomposition.ofCountableGenerator
  ...
  Classical.choice (exists_hahnDecomposition_ofCountableGenerator generator leftFinite rightFinite)
