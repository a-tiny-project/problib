...
public theorem union_add_inter (measure : Measure space)
  ...
  rw [unionMass, ENNReal.addComm (measure right) (measure (Set.difference left right)),
    ENNReal.addAssoc, ENNReal.addComm (measure right) (measure (Set.inter left right)),
    ← ENNReal.addAssoc,
    ENNReal.addComm (measure (Set.difference left right)) (measure (Set.inter left right)),
