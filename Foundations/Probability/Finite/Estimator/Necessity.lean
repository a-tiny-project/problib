...
namespace Foundations.Probability.FiniteEstimator.Necessity

open Foundations.Probability
open Foundations.Probability.FiniteExample
open Foundations.Probability.FiniteEstimator
...
theorem bad_coupling_does_not_have_the_claimed_left_marginal :
...
end Foundations.Probability.FiniteEstimator.Necessity
