...
namespace Foundations.Probability.FiniteEstimator
...
theorem inference_after_partial_evaluation_preserves_difference
    {Outcome : Type u}
...
end Foundations.Probability.FiniteEstimator
