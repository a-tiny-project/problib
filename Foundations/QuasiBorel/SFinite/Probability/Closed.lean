import Foundations.QuasiBorel.SFinite.Probability.Strength
import Foundations.QuasiBorel.SFinite.Closed
...
theorem ofProbability_internalExtend (kernel : Hom domain (Probability.object codomain)) :
  ...
  exact ofProbability_extend kernel

/-- Contextual bind morphism on parameter spaces commutes with inclusion into s-finite laws. -/
theorem ofProbability_bindContext {parameter : Space.{0, w} realSource}
